...
export default function CryptoWhitePapers() {
  return (
    <div className="flex flex-col justify-center items-center w-full">
      <div className="relative  w-[100%] group">
        <Image
          src="/cryptowhitepapers.png" // Replace with the correct path to your image
        ...
        />
        <a
          href="https://cryptowhitepapersonline.com/" // Replace with the correct URL
          target="_blank"
        ...
        >
          <span className="bg-blue-800 text-neutral-200 px-6 py-1 rounded-2xl flex flex-row gap-1 items-center">
            cryptowhitepapersonline.com <ArrowUpRight />
          </span>
        </a>
      </div>
      <button
      ...
      >
        <Link href="https://cryptowhitepapersonline.com/">
          Visit cryptowhitepapersonline.com
        </Link>
      </button>
    </div>
  );
