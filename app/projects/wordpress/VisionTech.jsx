...
export default function VisionTech() {
  return (
    <div className="flex flex-col justify-center items-center w-full">
      <div className="relative w-[100%] group">
        <Image
          src="/vision.png" // Replace with the correct path to your image
        ...
        />
        <a
          href="https://visiontech-solutions.com/" // Replace with the correct URL
          target="_blank"
        ...
        >
          <span className="bg-blue-800 text-neutral-200 px-6 py-1 rounded-2xl flex flex-row gap-1 items-center">
            visiontech-solutions.com <ArrowUpRight />
          </span>
        </a>
      </div>
      <button
      ...
      >
        <Link href="https://visiontech-solutions.com/">
          Visit visiontech-solutions.com
        </Link>
      </button>
    </div>
  );
