...
export default function Ssophia() {
  return (
    <div className="flex flex-col justify-center items-center w-full">
      <div className="relative w-[100%] group">
        <Image
          src="/ssophia.png" // Replace with the correct path to your image
        ...
        />
        <a
          href="https://ssophia.com/" // Replace with the correct URL
          target="_blank"
      ...
      >
        <Link href="https://ssophia.com/"> Visit ssophia.com </Link>
      </button>
    </div>
  );
}
